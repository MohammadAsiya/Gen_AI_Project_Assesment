...
# Qdrant details
 # Replace with your Qdrant API key
...
def upload_chunks_to_Qdrant(documents, collection_name):
    records_to_upload = []
...
if __name__ == "__main__":
    create_Qdrant_collection(QDRANT_COLLECTION_NAME)  # Create the collection
    documents = read_txt_files("courses-text-files")  # Update with your directory
    upload_chunks_to_Qdrant(documents, QDRANT_COLLECTION_NAME)  # Upload documents to Qdrant